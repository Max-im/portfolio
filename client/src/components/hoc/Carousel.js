...
export default class Carousel extends React.Component {
  ...
  onShift = e => {
    ...
    this.setState({firstItemIndex: this.state.firstItemIndex + val, lastItemIndex: this.state.lastItemIndex + val});
  }
  ...
  render() {
    ...
    return (
      <div className="carousel">
        ...
        <i className={lastItemIndex === arr.length ? "fas fa-chevron-right carousel__control carousel__control_disabled" : "fas fa-chevron-right carousel__control"} data-value={1} onClick={this.onShift}  />
      </div>
    );
  }
}
